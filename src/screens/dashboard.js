...
export function renderDashboard() {
    ...
    <main class="pt-24 px-6 max-w-7xl mx-auto pb-32">
        <div class="mb-8">
            <p class="font-label text-sm font-semibold tracking-wider text-secondary uppercase mb-1">Facility Live Status</p>
            <h2 class="text-3xl font-extrabold text-on-surface tracking-tight">Operating Department</h2>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-10">
            <div class="bg-surface-container-lowest p-6 rounded-full shadow-sm">
                <p class="text-sm font-label text-secondary font-medium text-center">Total Theaters</p>
            ...
            <div class="bg-surface-container-lowest p-6 rounded-full shadow-sm text-center">
                <p class="text-sm font-label text-secondary font-medium">Occupied</p>
                <p class="text-3xl font-bold text-error mt-1">8</p>
            </div>
            <div class="bg-surface-container-lowest p-6 rounded-full shadow-sm text-center">
                <p class="text-sm font-label text-secondary font-medium">Available</p>
            ...
            <div class="bg-surface-container-lowest p-6 rounded-full shadow-sm border-2 border-primary/5 text-center">
                <p class="text-sm font-label text-secondary font-medium">Turnover Rate</p>
                    ...
                    <div class="flex justify-between items-start mb-6">
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-xs font-label font-bold uppercase tracking-widest text-error">Occupied</span>
                            </div>
                        </div>
                        <div class="bg-error-container text-on-error-container px-4 py-2 rounded-xl text-center">
                            <p class="text-[10px] font-bold uppercase leading-none mb-1">Time Remaining</p>
                            <p class="text-xl font-black tabular-nums">00:42:15</p>
                        </div>
                    </div>
                    <div class="space-y-4">
                        <div class="bg-surface-container-low p-5 rounded-xl">
                            <label class="text-[10px] font-bold text-secondary uppercase tracking-wider mb-2 block">Current Procedure</label>
                            <p class="text-lg font-bold text-on-surface leading-snug">Laparoscopic Cholecystectomy</p>
                        </div>
                        <div class="flex items-center justify-between px-2">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="text-[10px] font-bold text-secondary uppercase tracking-tighter">Primary Surgeon</p>
                ...
                <div class="p-8">
                    <div class="flex justify-between items-start mb-6">
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                <span class="flex h-2 w-2 rounded-full bg-tertiary-container"></span>
                                <span class="text-xs font-label font-bold uppercase tracking-widest text-on-tertiary-fixed-variant">Cleaning</span>
                            </div>
                        </div>
                        <div class="bg-tertiary-fixed text-on-tertiary-fixed px-4 py-2 rounded-xl text-center">
                            <p class="text-[10px] font-bold uppercase leading-none mb-1">Elapsed Time</p>
                    ...
                    <div class="flex flex-col items-center justify-center py-8 text-center bg-surface/50 rounded-xl border-2 border-dashed border-outline-variant/30">
                        <span class="material-symbols-outlined text-4xl text-tertiary-container mb-2">mop</span>
                        <p class="font-bold text-on-surface">Terminal Cleaning in Progress</p>
                        <p class="text-sm text-secondary">Estimated completion in 6 minutes</p>
                    </div>
                    <div class="mt-6 flex justify-between items-center px-2">
                        <div class="flex items-center gap-2 text-secondary">
                            <span class="material-symbols-outlined text-sm">history</span>
                            <span class="text-xs font-medium">Last: Hip Arthroplasty (Dr. Miller)</span>
                        </div>
                        <button class="text-primary text-sm font-bold">Manage Staff</button>
                    </div>
                </div>
            </div>
        </div>
